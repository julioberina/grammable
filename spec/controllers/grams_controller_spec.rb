...
RSpec.describe GramsController, type: :controller do
  describe "grams#destroy action" do
    it "shouldn't allow users who didn't create the gram destroy the gram" do
    ...
    it "should allow users to successfully destroy grams" do
      gram = FactoryGirl.create(:gram)
      sign_in gram.user
      delete :destroy, params: { id: gram.id }
  ...
  describe "grams#update action" do
    it "shouldn't let users who didn't create the gram update the gram" do
      gram = FactoryGirl.create(:gram)
      user = FactoryGirl.create(:user)
      sign_in user
  ...
  describe "grams#edit action" do
    ...
    it "shouldn't let users who didn't create the gram edit the gram" do
      gram = FactoryGirl.create(:gram)
      user = FactoryGirl.create(:user)
      sign_in user
      get :edit, params: { id: gram.id }
    ...
    it "should returna 404 error if the gram is not found" do
      user = FactoryGirl.create(:user)
      sign_in user
  ...
  describe "grams#create action" do
    ...
    it "should successfully create a new gram in our database" do
      ...
      gram = Gram.last
      expect(gram.message).to eq("Hello World!")
